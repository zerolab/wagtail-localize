...
class TestTranslateSnippetListingButton(TestCase, WagtailTestUtils):
    ...
    def test(self):
        ...
        self.assertContains(response, (
            '<a aria-label="Translate &#x27;TestSnippet object (1)&#x27;" '
            'class="button button-secondary button-small" '
            f'href="/admin/localize/submit/snippet/wagtail_localize_test/testsnippet/{self.en_snippet.id}/?next=%2Fadmin%2Fsnippets%2Fwagtail_localize_test%2Ftestsnippet%2F"'
            '>Translate</a>'
        ))
